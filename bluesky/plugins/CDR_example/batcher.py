...
for density in traffic_densities:
    for seed in range(n_scenarios):
        for time in lookahead_time:
            f = open(rf"C:\Coding\bluesky_fork2\scenario\batches\scenarios\{fileheader_state_CD}_{seed}_{density}_{time}.scn","w")
#
...
##
        ...
        #
        #
            filelist.append(f"{fileheader_state_CD}_{seed}_{density}_{time}")
...
f_bat = open(rf"C:\Coding\bluesky_fork2\scenario\batch_10.scn","w")
